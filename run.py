...
def calculate_surplus_data(sales_row):
    ...
    stock_row = stock[-1] #Get the last row of stock data//this is a list of strings

    surplus_data = []
    #Zip function allows to iterate over two lists at the same time
...
def get_last_5_entries_sales():
    ...
    for ind in range(1, 7):
        column = sales.col_values(ind)#Get all values in the column
        columns.append(column[-5:])#Append the last 5 values from the column
